# **StateManager** Application Microservice

Der StateManager kümmert sich um die Erweiterung eines medizinischen Gerätes mit einem Status und den Funktionen, die benötigt werden, um den Status zu verwalten.
